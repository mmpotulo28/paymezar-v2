...
export const PLAN_DETAILS: Record<string, iPricingPlan> = {
	starter: {
		name: "Starter",
		description: "For individuals and casual users to send and receive ZAR stablecoin.",
	...
	pro: {
		name: "Pro",
		description: "For active users and freelancers needing higher limits and more features.",
	...
	business: {
		name: "Business",
		description: "For businesses and power users with advanced needs and unlimited usage.",
