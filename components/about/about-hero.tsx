	...
	return (
		<motion.div
			...
			<p className="text-lg md:text-xl text-default-700 font-medium mb-2">
				Empowering South Africa with instant, secure, and borderless ZAR stablecoin
				payments.
			</p>
			<p className="text-base text-default-500 max-w-xl mx-auto mb-4">
				Our mission is to make digital payments accessible for everyone. Whether you’re a
				freelancer, business, or everyday user, PayMe-Zar is designed for you.
			</p>
		</motion.div>
	);
}
