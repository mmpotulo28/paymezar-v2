        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    cacheKey = "user_balances_".concat(userId);
                    _d.label = 1;
                case 1:
                    ...
                    return [4 /*yield*/, axios.get("".concat(API_BASE, "/").concat(userId, "/balance"), {
                            headers: {
                ...
                case 3:
                    ...
                    if (((_a = err_1 === null || err_1 === void 0 ? void 0 : err_1.response) === null || _a === void 0 ? void 0 : _a.status) === 400)
                        setBalancesError("Invalid user ID.");
                    else if (((_b = err_1 === null || err_1 === void 0 ? void 0 : err_1.response) === null || _b === void 0 ? void 0 : _b.status) === 401)
                        setBalancesError("Unauthorized.");
                    else if (((_c = err_1 === null || err_1 === void 0 ? void 0 : err_1.response) === null || _c === void 0 ? void 0 : _c.status) === 404)
                        setBalancesError("User not found.");
                    else
