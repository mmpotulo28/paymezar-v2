      ...
      <Card className="w-full max-w-3xl">
        <CardHeader className="flex flex-col items-center gap-2">
          ...
          <p className="text-default-500 text-center max-w-xl">
            These terms govern your use of PayMe-Zar. Please read them
            carefully.
          </p>
        </CardHeader>
        <CardBody className="flex flex-col gap-6 text-default-700 text-base">
          <section>
            ...
            <p>
              By using PayMe-Zar, you agree to these terms and our privacy
          ...
          <section>
            ...
            <p>
              You must be at least 18 years old and reside in South Africa to
              use PayMe-Zar.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              All fees are clearly stated on our Pricing page. You are
              responsible for any applicable fees and taxes.
            </p>
          </section>
          <section>
            ...
            <p>
              ...
              violation of these terms or for suspicious activity.
            </p>
          </section>
          <section>
            <h2 className="font-semibold mb-2">7. Limitation of Liability</h2>
            <p>
              PayMe-Zar is not liable for any indirect, incidental, or
          ...
          <section>
            ...
            <p>
              We may update these terms at any time. Continued use of PayMe-Zar
