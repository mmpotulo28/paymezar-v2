      ...
      <Card className="w-full max-w-3xl">
        ...
        <CardBody className="flex flex-col gap-6 text-default-700 text-base">
          ...
          <section>
            ...
            <p>
              We use bank-grade encryption and security best practices to
              protect your data. Access is restricted to authorized personnel
              only.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              time by contacting support or using your account dashboard.
            </p>
          </section>
          <section>
